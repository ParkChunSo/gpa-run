...
public class Test extends Transition {
    public Image Character_Image = ResourceUtil.getImage(ImageNm.Character_Run_Image);
//    public Image Sliding_Image = ResourceUtil.getImage(ImageNm.Character_Run_Image);
...
//    public Image fever_Image = new Image(getClass().getClassLoader().getResource("./ImageFile/fever.png").toString(),true);
    ...
    public Test(ImageView imageView, Duration duration, int count, int columns, int offsetX, int offsetY,
